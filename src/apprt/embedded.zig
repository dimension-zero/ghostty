...
pub const App = struct {
    ...
    fn ipcCloseTabHandler(
        ...
        const mode: action.CloseTabMode = if (params) |p| blk: {
    ...
    fn ipcGotoTabHandler(
        ...
        const goto_tab: action.GotoTab = @enumFromInt(index);
    ...
    fn ipcToggleFullscreenHandler(
        ...
        const mode: action.Fullscreen = if (params) |p| blk: {
    ...
    fn ipcNewSplitHandler(
        ...
        const direction: action.SplitDirection = if (params) |p| blk: {
